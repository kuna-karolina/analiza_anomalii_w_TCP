...
df = df.drop(columns=["http.file_data","http.content_length","http.request.uri.query","http.request.method","http.referer","http.request.full_uri",
...
df.to_csv("SQL_injection_attack_preprocessed.csv", index=False)
